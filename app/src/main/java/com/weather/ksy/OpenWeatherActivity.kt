...
//                    loading_text.text = "로딩 실패"
                    Toast.makeText(this@OpenWeatherActivity, "로딩 실패 " + t.message, Toast.LENGTH_SHORT).show()
                ...
                override fun onResponse(call: Call<TotalWeather>, response: Response<TotalWeather>) {
                    if (response.isSuccessful) {
                        ...
                        progress_bar.visibility = View.GONE
                        Toast.makeText(this@OpenWeatherActivity, "로딩 실패 " + response.errorBody(), Toast.LENGTH_SHORT)
                            .show()
                    }
                }
            })
